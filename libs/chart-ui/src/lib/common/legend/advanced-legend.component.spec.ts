...
describe('<ngx-charts-advanced-legend>', () => {
    ...
    function loadLegendItemElements(fixture: ComponentFixture<TestComponent>) {
        ...
        const legendItemValueElements =
            fixture.debugElement.nativeElement.querySelectorAll('.legend-items .item-value');
        const legendItemLabelElements =
            fixture.debugElement.nativeElement.querySelectorAll('.legend-items .item-label');
