...
export class CreateTaxDialogComponent extends BaseComponent implements OnInit {
    ...
    public dialogRef = inject<MatDialogRef<CreateTaxDialogComponent>>(MatDialogRef);
    public data = inject<{
        formConfig: any;
        dialogTitle?: string;
    ...
    constructor() {
        ...
        this.dialogTitle = this.data.dialogTitle || 'Taxes';
        this.submitButtonText = this.data.submitButtonText || 'Save';
